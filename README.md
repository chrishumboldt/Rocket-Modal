...
`reveal` | `slide-from-top` | `appear` `appear-scale` `slide-from-bottom`<br>`slide-from-left` `slide-from-right` `slide-from-top` | Set the reveal animation.
`revealLarge` | | `appear` `appear-scale` `slide-from-bottom`<br>`slide-from-left` `slide-from-right` `slide-from-top` | Set the reveal animation after the breakpoint has been reached.<br>**NOTE** that false means the already existing reveal animation will be used.
